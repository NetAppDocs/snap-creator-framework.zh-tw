...
NOTE: 如果您要從 SnapVault 副本還原，系統會提示您從主要儲存設備或次要儲存設備還原。您的選擇取決於您如何處理 link:concept_domino_database_restore_overview.html["Concention_DOMIN_database_STAGE_overvice.MD#GUID-4D864E7-DE54F-4B9F-EF2F240F65D9"] 中所述的限制。
